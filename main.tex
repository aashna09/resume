...
\resumeItemWithoutTitle{Held full accountability for launching new Point Of Sale (POS) stores for client, Tiffany \& Co., overseeing everything from database configurations to establishing end-to-end data pipelines, thereby ensuring smooth data integration across the newly inaugurated locations.}
